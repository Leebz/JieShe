...
import com.whut.JieShe.adapter.VpageAdapter;
...
public class GuidePageActivity extends Activity implements ViewPager.OnPageChangeListener {
    ...
    private int[] ps={R.id.point1,R.id.point2,R.id.point3,R.id.point4};//定义引导页上的两个点
    ...
    private void init() {
        ...
        views.add(inflate.inflate(R.layout.guide_third, null));
        views.add(inflate.inflate(R.layout.guide_forth, null));
        vad=new VpageAdapter(views, this);
        vp=(ViewPager) findViewById(R.id.viewpager);
        vp.setAdapter(vad);
        vp.setOnPageChangeListener(this);
        intobutton=(Button) views.get(3).findViewById(R.id.into);
